...
from .bot_get import (
    ...
    get_user_followers_id,
    get_user_following_id,
    get_user_followers_username,
...
class Bot(object):
    ...
    def following(self):
        ...
        if self._following is None or (now - last) > 7200:
            ...
            self._following = self.get_user_following_id(self.user_id)
    ...
    def followers(self):
        ...
        if self._followers is None or (now - last) > 7200:
            ...
            self._followers = self.get_user_followers_id(self.user_id)
    ...
    def get_user_followers_id(self, user_id, nfollows=None):
        return get_user_followers_id(self, user_id, nfollows)

    def get_user_following_id(self, user_id, nfollows=None):
        return get_user_following_id(self, user_id, nfollows)

    def get_user_followers_username(self, user_id, nfollows=None):
        return get_user_followers_username(self, user_id, nfollows)

    def get_user_following_username(self, user_id, nfollows=None):
        return get_user_following_username(self, user_id, nfollows)
